...
public class Custom_Char : MonoBehaviour
{
    ...
    private void Start()
    {
        customChar = GameObject.FindWithTag("CustomChar");
        ...
        {
            hairParts[i] = customChar.transform.GetChild(23).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(4).GetChild(0).GetChild(0).GetChild(i).gameObject;
        }

        for (int i = 0; i < MAX_EYE; i++)
        {
            eyeParts[i] = customChar.transform.GetChild(23).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(4).GetChild(0).GetChild(1).GetChild(i).gameObject;
        }

        for (int i = 0; i < MAX_MOUTH; i++)
        {
            mouthParts[i] = customChar.transform.GetChild(23).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(4).GetChild(0).GetChild(2).GetChild(i).gameObject;
        }

        for (int i = 0; i < MAX_MUSTACHE; i++)
        {
            mustacheParts[i] = customChar.transform.GetChild(23).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(4).GetChild(0).GetChild(3).GetChild(i).gameObject;
        }

        for (int i = 0; i < MAX_BODY; i++)
        {
            bodyParts[i] = customChar.transform.GetChild(i).gameObject;
        }       
    }
